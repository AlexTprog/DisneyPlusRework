 ...
 */
public class ControladorEditarPerfiles {

    private frmEditarPerfiles vista;
    private ArregloUsuario modelo;

    public ControladorEditarPerfiles(frmEditarPerfiles vista, ArregloUsuario modelo) {
        this.vista = vista;
        this.modelo = modelo;
        
        this.vista.btnListo.addActionListener(new ActionListener() {
            @Override
